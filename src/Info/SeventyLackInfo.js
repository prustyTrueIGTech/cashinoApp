...
export const SeventyLacksInfo = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-4 bg-white text-black font-sans text-sm">
      {/* Logo */}
      <img src={Logo} className="w-auto h-12 mx-auto mb-4" alt="Logo" />

      {/* Title */}
      <h2 className="text-xl sm:text-2xl font-bold text-center mb-4 underline decoration-dashed decoration-2 decoration-red-500">
        HOW TO PLAY?
      </h2>
      ...
      {/* Result Number */}
      <div className="bg-orange-600 text-white text-center font-bold p-2 rounded-full mx-auto mb-4 w-3/4 sm:w-1/2">
        {result_Number}
      </div>

      {/* Prize Table */}
      <div className="overflow-x-auto mb-8 bg-yellow-400 p-2 rounded-md">
        <table className="table-auto w-full text-sm border border-gray-300 text-center border-separate">
          <thead>
            <tr className="bg-orange-500 text-white text-sm sm:text-base font-bold">
              <th className="border px-3 py-2">Prizes</th>
              <th className="border px-3 py-2">No. of Results to be Drawn</th>
              <th className="border px-3 py-2">Demo Ticket No.</th>
              <th className="border px-3 py-2">&</th>
              <th className="border px-3 py-2">How to Match?</th>
            </tr>
          </thead>
          <tbody className="bg-[#5c2d91] text-white font-medium">
            <tr>
              ...
              <td className="border px-3 py-2">A-99684</td>
              <td className="border px-3 py-2">-</td>
              <td className="border px-3 py-2">5 digits with series</td>
            </tr>
            <tr>
              <td className="border px-3 py-2">
                Cons. Prize ₹50,000
            ...
            <tr>
              ...
              <td className="border px-3 py-2">A-99684</td>
              <td className="border px-3 py-2">-</td>
              <td className="border px-3 py-2">5 digits without series</td>
            </tr>
            <tr>
              <td className="border px-3 py-2">
                3rd Prize ₹9,000
              ...
              <td className="border px-3 py-2">A-99684</td>
              <td className="border px-3 py-2">-</td>
              <td className="border px-3 py-2">Last 4 digits without series</td>
            </tr>
            <tr>
              <td className="border px-3 py-2">
                4th Prize ₹5,000
      ...
      {/* Key Points */}
      <div className="pb-8">
        <h3 className="text-lg font-semibold mb-3 flex justify-center items-center underline decoration-dashed decoration-2 decoration-red-500">
          Key Points
        </h3>
