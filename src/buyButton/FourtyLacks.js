...
import thirtyLacks from "../assets/png/girl6.png"; // Image import
...
import { FourtyLacksInfo } from "../Info/FourtyLacksInfo";
import Dialog from "../components/ui/dialog";

export const FourtyLacks = () => {
  const bunch1Tickets = [
    "A/01108",
    "A/01113",
    "A/01121",
  ...
  function addToCart(ticket) {
    ...
    const renderDialogContent = () => {
      if (activeButton?.name === "Info")
        return <FourtyLacksInfo onClose={handleClose} />;
      return null;
    };
