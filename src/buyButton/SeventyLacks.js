...
import thirtyLacks from "../assets/png/girl8.png"; // Image import
...
import { SeventyLacksInfo } from "../Info/SeventyLackInfo";
import Dialog from "../components/ui/dialog";

export const SeventyLacks = () => {
  const bunch1Tickets = [
    "A/01108",
    "A/01113",
    "A/01121",
  ...
  const renderDialogContent = () => {
    if (activeButton?.name === "Info")
      return <SeventyLacksInfo onClose={handleClose} />;
    return null;
  };
