...
export const Upcoming_Attraction = () => {
  ...
  const handleBuyNow = (title) => {
    ...
    } else if (title === "TrueGETCH_60_Weekly") {
      navigate("/trueIgTech_60_weekly_lottery");
    } else if (title === "TrueGETCH_1cr_Weekly") {
      navigate("/trueIgTech_1cr_weekly_lottery");
    } 
    
    else {
      navigate("/trueIgTech_21_weekly_lottery");
    }
  };
  ...
  return (
    <div className="py-10">
      <div className="flex items-center justify-center gap-2 mb-6">
        <span className="flex-1 text-2xl font-semibold text-center">
          ...
          <div key={index} className="[perspective:1000px]">
            ...
            >
              <div className="backface-hidden">
                ...
                <div
                  className={`text-white text-center px-4 py-4 rounded-b-3xl ${coupon.footer}`}
                >
                  <button
                  ...
                  <p className="text-sm">
                    Draw: {coupon.date} &nbsp; Time: {coupon.time}
                  </p>
